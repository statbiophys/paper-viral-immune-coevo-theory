...
#color_cycle = ["#001C7F", "#017517", "#8C0900", "#7600A1", "#B8860B", "#006374"]
color_cycle = cycler('color', ["blue", "green", "red", "magenta", "gold", "cyan", "brown", "midnightblue",  "slategrey",  "darkgoldenrod",  "greenyellow"])
...
linedotstyle = dict(linestyle='-', color='b', linewidth=0.75 * linewidth,
                    marker='.', ms=1.25)
